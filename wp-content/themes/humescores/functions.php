...
if (!function_exists('humescores_setup')) :
    ...
    function humescores_setup() {
        ...
        //remove ability to change BG color/image
...
function humescores_fonts_url() {
     ...
     * supported by our two bib lettuce lookin' fonts , translate this to 'off'. Do not translate
     * into your own language.
     */
//	
    $cormorant = _x('on', 'Cormorant Garamond font: on or off', 'humescores');
    $quattrocento = _x('on', 'Quattrocento font: on or off', 'humescores');
//                    https://fonts.googleapis.com/css?family=Cormorant+Garamond:300,400,700|Quattrocento:400,700');
    $font_families = array();


    if ('off' !== $cormorant) {
        $font_families[] = 'Cormorant Garamond:300,400,700';
    }
    if ('off' !== $quattrocento) {
        $font_families[] = 'Quattrocento:400,700';
    }
    if (in_array('on', array($cormorant, $quattrocento))) {
        $query_args = array(
    ...
    register_sidebar(array(
      ...
      register_sidebar(array(
        ...
        'after_title' => '</h2>',
          ...
          register_sidebar(array(
        'name' => esc_html__('Page-widget', 'humescores'),
        'id' => 'sidebar-3',
        'description' => esc_html__('Add widgets here.', 'humescores'),
        'before_widget' => '<section id="%1$s" class="page-widget widget %2$s">',
        'after_widget' => '</section>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
    ));
...
function humescores_scripts() {
    ...
    //Google Fonts enque
    //load google webfont stylesheet
    //
     wp_enqueue_style('humescores-fonts', humescores_fonts_url());
    //   wp_enqueue_style('gfonts-fonts', 'https://fonts.googleapis.com/css?family=Cormorant+Garamond:300,400,700|Quattrocento:400,700');
